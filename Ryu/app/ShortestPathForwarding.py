...
class ShortestPathForwarding(app_manager.RyuApp):
    ...
    #event is not from openflow protocol, is from switchs' state changed
    ...
    def get_out_port(self,datapath,src,dst,in_port):
        ...
        #first: DONOT find src host at graph
        ...
        if dst in self.network:
            ...
            #By flood, to find dst, when dst get packet, dst will send a new back,the graph will record dst info
